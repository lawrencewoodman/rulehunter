...
func TestLoad(t *testing.T) {
	cases := []struct {
		...
		{filepath.Join("fixtures", "config_nomaxnumcacherecords.yaml"),
			&Config{
				ExperimentsDir:     "experiments",
				WWWDir:             "www",
				BuildDir:           "build",
		...
		{filepath.Join("fixtures", "config_minusmaxnumcacherecords.yaml"),
			&Config{
				ExperimentsDir:     "experiments",
				WWWDir:             "www",
				BuildDir:           "build",
...
func configsMatch(c1, c2 *Config) bool {
	return c1.ExperimentsDir == c2.ExperimentsDir &&
		...
		c1.MaxNumCacheRecords == c2.MaxNumCacheRecords
}
